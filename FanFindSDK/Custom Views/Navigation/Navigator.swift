...
public enum Navigator {
    ...
    public static func isInstalled(_ app: NavigationApp) -> Bool {
    ...
    public static func launch(app: NavigationApp,
    ...
    private static func _launch(app: NavigationApp,
                                origin: LocationRepresentable?,
                                destination: LocationRepresentable,
                                mode: Mode?) throws {
        guard app != .appleMaps else {
            guard app.supports(mode: mode) else { throw Navigator.Error.unsupportedMode }
        ...
        guard let queryString = app.queryString(origin: origin,
                ...
                throw Navigator.Error.unsupportedMode
        }
    ...
    public static func createPicker(origin: LocationRepresentable? = nil,
                                    ...
                                    completion: ((NavigationApp) -> Void)? = nil)
        -> UIAlertController {
            let alert = UIAlertController(title: title, message: message, preferredStyle: style)
            
            NavigationApp.allCases
                ...
                .map { app in
                    ...
                    let bundle = Bundle(for: DealsTableViewCell.self)
                    let image = UIImage(named: app.image, in: bundle, compatibleWith: nil)
